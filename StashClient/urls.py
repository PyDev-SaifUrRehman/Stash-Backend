...
from .views import (
    ...
    ReferralViewSet,
    ClaimViewSet,
    ClientWalletDetialViewset,
    UserLoginViewset,
    GetRefAdressViewset,
    ServerInformationViewset,
    TransactionViewset,
    AuthorizedNodeViewset,
    ExhaustedNodeViewset,
    GeneratedSubNodesViewset,
    EthereumDataVewiset,
    FirstTimeBuyingViewset,
)

router = DefaultRouter()

router.register(r"user-signup", ClientUserViewSet, basename="user")
router.register(r"client-wallet", ClientWalletDetialViewset, basename="client-wallet")
router.register(r"get-ref-address", GetRefAdressViewset, basename="get-ref-address")
...
router.register(r"first-buy", FirstTimeBuyingViewset, basename="first-buy")
