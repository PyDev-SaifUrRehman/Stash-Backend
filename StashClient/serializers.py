...
class ClientUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ClientUser
        fields = '__all__'
        read_only_fields = ['referral_code', 'maturity', 'total_deposit', 'referred_by',
                            'total_revenue', 'claimed_reward', 'generated_reward', 'is_purchased']
...
class TransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ['sender', 'node_id', 'transaction_type', 'amount', 'trx_hash', 'server_type', 'timestamp', 'supernode_quantity', 'stake_swim_quantity',
                  'setup_charges', 'node_quantity', 'node', 'block_id', 'master_node_eth2', 'super_node_eth2', 'referred_nodepass', 'nodepass', 'referred_wallet_address']
...
class ClaimSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ['sender', 'node_id', 'transaction_type',
                  'amount', 'block_id', 'trx_hash', 'node']
