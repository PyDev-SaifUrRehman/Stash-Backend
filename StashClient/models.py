...
class ClientUser(BaseUser):
    ...
    total_subnode_generated = models.PositiveIntegerField(default=0)
    total_supernode_generated = models.PositiveIntegerField(default=0)
    is_supernode_masternode_purchased = models.BooleanField(default=False)
...
class Referral(models.Model):
    ...
    super_node_ref = models.ForeignKey(
        ...
        related_name="super_node_ref",
        null=True,
        blank=True,
    )
    master_node_ref = models.ForeignKey(
        ClientUser,
        on_delete=models.CASCADE,
        related_name="master_node_ref",
        null=True,
        blank=True,
    )
    sub_node_ref = models.ForeignKey(
        ClientUser,
        on_delete=models.CASCADE,
        related_name="subnode_ref",
        null=True,
        blank=True,
    )
...
class Transaction(models.Model):
    ...
    TRANSACTION_TYPE = [
        ...
        ("MasterNode Nodepass", "MasterNode Nodepass"),
        ("SuperNode Nodepass", "SuperNode Nodepass"),
    ]
    ...
    node = models.ForeignKey(
        "StashAdmin.NodeSetup",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
        related_name="trx_node",
    )
    ...
    referred_wallet_address = models.ForeignKey(
        ClientUser,
        on_delete=models.CASCADE,
        related_name="transactions_ref",
        null=True,
        blank=True,
    )
